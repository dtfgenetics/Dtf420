...
const ignoredDirs = new Set(['.git', 'node_modules', '.next', 'out', 'dist', 'build', 'coverage', 'vendor', 'artifacts']);
...
if (violations.length) {
  console.error('Browser-tool policy violation: Playwright execution/dependency wiring is prohibited in active DTF420 workflows and package manifests.');

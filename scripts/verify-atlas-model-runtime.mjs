...
for (const [needle, label] of [
  ...
  ["createSemanticHotspotProxies", "semantic hotspot proxy builder"],
  ["atlasSemanticProxy", "semantic hotspot proxy identity"],
  ["entityMaterials.has(entityId)", "real semantic mesh precedence"],
  ["semanticProxies.forEach", "semantic hotspot proxy cleanup"],
  ["atlasSemanticProxies", "semantic hotspot runtime reporting"],

    ...
    <>
      <div className={styles.libraryControls} role="search" aria-label="Filter game library">
        ...
        <label className={styles.searchField}>
          ...
          <input aria-controls="game-library-results" aria-describedby="game-library-result-count" aria-keyshortcuts="Escape" autoCapitalize="none" autoComplete="off" enterKeyHint="search" spellCheck={false} value={query} onChange={(event) => setQuery(event.target.value)} onKeyDown={(event) => { if (event.key === "Escape") setQuery(""); }} placeholder="Search games or genres" type="search" />
        </label>
      </div>

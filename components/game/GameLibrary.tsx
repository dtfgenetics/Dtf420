    ...
    <>
      <div className={styles.libraryControls} role="search" aria-label="Filter game library">
        ...
        <label className={styles.searchField}>
          ...
          <input aria-controls="game-library-results" aria-describedby="game-library-result-count" autoComplete="off" enterKeyHint="search" value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Search games or genres" type="search" />
        </label>
      </div>

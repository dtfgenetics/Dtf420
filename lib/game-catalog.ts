...
export const gameCatalog: readonly GameCatalogEntry[] = [
  {
    ...
    genre: "Board",
    status: "playable",
    features: ["2–8 local players", "40-space illustrated board", "Save + load", "Property upgrades"],
  ...
  },
  {
    ...
    description: "Race up to 50 ducks in Derby, River Rally, and high-chaos party modes with repeatable seeded races, live rankings, and multiplayer-ready race logic.",
    format: "River racing · 1–50 racers",
    genre: "Arcade",
    status: "preview",
    features: ["Up to 50 racers", "3 race modes", "Repeatable seeded races", "Live rankings"],
    actionLabel: "Race preview",
    actionAriaLabel: "Open Stoner Duck Race preview",
  },
  {
    slug: "who-took-it",
    title: "Who Took It?",
  ...
  },
  {
    ...
    description: "Guide Seed Man through 12 side-scrolling stages across six grow worlds with running momentum, double jump, checkpoints, moving platforms, pest enemies, trichome collectibles, three phenotype powers, and a final boss.",
    format: "Retro platformer · 1 player",
    genre: "Arcade",
    status: "playable",
    features: ["12 side-scrolling stages", "Double jump + run", "Fire + Electric + Ice", "Checkpoints + final boss"],
    actionLabel: "Play Seed Man",
    actionAriaLabel: "Play Seed Man Seed Ascent",
  },
  {
    slug: "thc-rpg",
    title: "THC RPG",
    ...
    description: "Begin with Blue Mango, manage phenotype variation and room conditions, earn equipment upgrades, move into Blue Bubblegum, hunt for a high-quality Mango Bubbles phenotype, preserve Keeper stock, and continue into advanced genetics trials.",
    format: "Cultivation RPG · 1 player",
    genre: "RPG",
    status: "playable",
    features: ["Expanded genetics campaign", "Phenotype variation", "Equipment progression", "Autosave + recovery"],
  ...
  },
  {
    ...
    actionAriaLabel: "Play High IQ preview",
  },
  {
    ...
    actionAriaLabel: "Open Grower Conversations preview",
  },
  {
    slug: "strain-showdown",
    title: "Strain Showdown",
    strapline: "Compare Power. Protect Vigor.",
    heading: "Choose two strains. Resolve the showdown.",
    description: "Match any two cards from the 48-card Tier 1 set, compare Vigor and Power, trigger family effects, and follow the battle exchange while the larger deck-building game continues to expand.",
    format: "Battle card game · playable preview",
    genre: "Cards",
    status: "preview",
    features: ["48 Tier 1 cards", "8 families", "Vigor + Power", "Family battle effects"],
    actionLabel: "Play showdown",
    actionAriaLabel: "Play Strain Showdown preview",
  },
  {
    slug: "phenoquest",
    title: "PhenoQuest",
    ...
    actionAriaLabel: "Explore PhenoQuest 3D preview",
  },
  {
    slug: "burn-buds",
    title: "Burn Buds",
    ...
    description: "Create or join a room, place a five-piece cannabis-themed fleet on a 15 × 15 grid, trade server-authoritative shots turn by turn, recover interrupted matches, and run it back with rematch consent.",
    format: "Multiplayer fleet battle · 2 players",
    genre: "Strategy",
    status: "playable",
    features: ["15 × 15 battle grid", "Room codes + recovery", "Server-authoritative turns", "Touch + keyboard"],
    actionLabel: "Play Burn Buds",
    actionAriaLabel: "Play Burn Buds multiplayer strategy game",
    posterStyle: "grid",
  },
] as const;

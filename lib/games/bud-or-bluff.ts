...
export const budOrBluffCards: readonly BudOrBluffCard[] = [
  ...
  realCard("BOB-002", "Cat Piss", "Easy"),
  ...
  realCard("BOB-049", "Moby Dick", "Easy"),
  ...
  bluffCard("BOB-021", "Blueberry Parking Lot", "Easy"),
  bluffCard("BOB-022", "Grandma's Gas Tank", "Easy"),
  ...
  bluffCard("BOB-029", "Sour Tax Refund", "Easy"),
  ...
  bluffCard("BOB-039", "Cream Soda Felony", "Easy"),
  bluffCard("BOB-040", "Alien Lunch Money", "Easy"),

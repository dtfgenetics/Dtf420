...
export const metadata: Metadata = buildEducationMetadata({
  ...
  description:
    "DTF's connected cultivation education system for guided courses, plant science, diagnostics, greenhouse and outdoor cultivation, post-harvest science, visual learning, field tools, glossary terms, and evidence sources.",
  path: "/learn",
});
...
const startHere = [
  ...
  },
  {
    ...
    description:
      "Search lessons, glossary terms, symptom references, plant-health material, cultivation science, field tools, and evidence sources from one education index.",
    href: "/learn/search",
  ...
  return (
    <>
      <section className="shell page-section">
        ...
        <h1>Learn</h1>
        <p className="lede">
          A connected cultivation education system built around plant function, direct observation, measurement, visual learning, evidence-based diagnostics, transparent sourcing, repeatable field records, and consistent plant-science vocabulary.
        </p>
      </section>

      ...
      <div className={styles.libraryGrid}>
        ...
        <article className={styles.gameCard}>
          ...
          <div className={styles.cardBody}>
            ...
            <p>
              A cannabis-themed side-scrolling platform adventure with six worlds, running momentum, double jump, checkpoints, moving platforms, pest enemies, trichome collectibles, and three power-up systems.
            </p>
            <div className={styles.tagRow} aria-label="Seed Ascent features">
              <span className={styles.tag}>6 side-scrolling levels</span>
              <span className={styles.tag}>Double jump + run</span>
              <span className={styles.tag}>Power-ups + checkpoints</span>
              <span className={styles.tag}>Desktop + touch</span>
            </div>
            <div className={styles.cardAction}>

...
For any browser-game task in this repository, first load `$dtf-game-location-resolver` from `.agents/skills/dtf-game-location-resolver/SKILL.md`, then `$dtf-game-dossier-resolver` from `.agents/skills/dtf-game-dossier-resolver/SKILL.md`, then load and follow `$dtf-game-router` from `.agents/skills/dtf-game-router/SKILL.md` before editing game code.
